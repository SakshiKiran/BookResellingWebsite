	  ...
	  if(isset($_SESSION["loggedin"]))
	     {
	      ...
	      {  
	           ...
	           {  
	                ...
	                echo '<script>alert("Book is added to cart")</script>';  
	                echo '<script>window.location="welcome.php"</script>'; 
	           }  
	           else  
	           {  
	                echo '<script>alert("Book is Already Added")</script>';  
	                echo '<script>window.location="welcome.php"</script>';  
	           }  
	      }  
	      else  
	...
	<li>
	          ...
	          ?>
	            ...
	            <ul class="nav navbar-nav navbar-right">
	              ...
	              <span class="badge abc"><?php echo"$num_items_in_cart"?></span></a></li>
	                  
	              <li class="dropdown">
	                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
	                  <i class="glyphicon glyphicon-user"></i> <span class="caret"></span></a>
	                    <ul class="dropdown-menu">
	                      <li><a href="upload.php">Sell a book</a></li>
	      ...
	      <div class="row">
	        ...
	        <?php
	          if($num1>0){
	            ...
	            {
	            ?> 
	            <form action="welcome.php?action=add&id=<?php echo $book["id"]; ?>" method="post">
